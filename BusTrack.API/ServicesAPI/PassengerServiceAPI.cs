...
namespace BusTrack.BusTrack.API.ServicesAPI
{
    public class PassengerServiceAPI : IPassengerServiceAPI
    {
        ...
        public async Task<IEnumerable<PassengerDTOAPI>>
            GetAllPassengers()
        {
            var passengers =
        ...
        public async Task<List<PassengerDB>>
            GetPassengers()
        {
            var passengers =
                (
            ...
            PassengerDTOAPI passengerDto)
        {
                ...
                passengerDB.Id))
            {
                throw new ArgumentException(
                    "O ID do passageiro é obrigatório.",
                    nameof(passengerDto));
            }
