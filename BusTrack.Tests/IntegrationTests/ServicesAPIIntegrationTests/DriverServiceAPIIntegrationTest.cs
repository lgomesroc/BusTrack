...
namespace BusTrack.Tests.IntegrationTests.ServicesAPIIntegrationTests
{
    public class DriverServiceAPIIntegrationTest
    {
        ...
        public async Task GetAllDrivers_ReturnsAllDrivers()
        {
            ...
            _driverRepository
                .Setup(x =>
                    x.GetAllDriversAsync())
                .ReturnsAsync(
                    drivers.AsEnumerable());
        ...
        public async Task CreateDriver_CreatesAndMapsDriver()
        {
            var newDriverDto =
                ...
                {
                    Name = "Jane Doe",
                    LicenseNumber = "DEF54321"
                };

            var expectedDriverId =
                "new-driver-id";
            ...
            Assert.Equal(
                newDriverDto.LicenseNumber,
                addedDriverDto.LicenseNumber);
        }
        ...
        public async Task UpdateDriver_UpdatesAndMapsDriver()
        {
            ...
            Assert.Equal(
                ...
                updatedDriverDto.Name);

            Assert.Equal(
                updateDriverDto.LicenseNumber,
                updatedDriverDto.LicenseNumber);
        }
